var TabSwitcher = function()
{
    ...
    this.initialize = function( ulWrapper )
    {
        ...
        this.ul.after( '<div class="ui-switch-button-bg ui-switch-button-bg-next"><button class="ui-switch-button ui-switch-next">&gt;</button></div>' );
        this.ul.after( '<div class="ui-switch-button-bg ui-switch-button-bg-prev"><button class="ui-switch-button ui-switch-prev">&lt;</button></div>' );
        ...
        this.prevBut = this.wrapper.find( '.ui-switch-button-bg .ui-switch-prev' );
        this.nextBut = this.wrapper.find( '.ui-switch-button-bg .ui-switch-next' );
    ...
    this._recalcTabsLimits = function()
    {
        ...
        this.rightTabLimit = this.wrapper.offset().left + this.wrapper.outerWidth() - this.butOuterWidth;
    };
    ...
    this.moveRight = function()
    {
        ...
        var additionalMargin = this.leftTabLimit - tabStart.offset().left;
        var currentMargin = parseInt( this.firstTab.css( 'marginLeft' ) );
